...
不确定自己的想法属于哪一类？[先开个 issue](https://github.com/your-org/html-anything/issues/new)，我们帮你定位到对应的目录。
...
- 架构问题、设计问题、"这算 bug 还是误用" → [GitHub Discussions](https://github.com/your-org/html-anything/discussions)（首选 —— 下一个遇到同样问题的人能搜到）。
